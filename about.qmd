...
In both the long and short term, three main factors consistently influence a song's popularity: **danceability, energy, and valence**. Generally, songs that are energetic, positive, and danceable tend to perform well.
...
-   It appears that Brazil consistently has the most streams so they are the largest target demographic.
